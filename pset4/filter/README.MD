...
The files are already written out for you. You just need to create the image filtering functions in helpers.c .
...
sepiaRed = .393 x originalRed + .769 x originalGreen + .189 x originalBlue
sepiaGreen = .349 x originalRed + .686 x originalGreen + .168 x originalBlue
sepiaBlue = .272 x originalRed + .534 x originalGreen + .131 x originalBlue
